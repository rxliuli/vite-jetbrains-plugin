...
class ViteCliProjectGenerator : NpmPackageProjectGenerator() {
    private val LOG = Logger.getInstance(ViteCliProjectGenerator::class.java)
    ...
    override fun getName(): String {
        return "vite.project.generator.name"
    }

    override fun getDescription(): String {
        return "vue.project.generator.description"
    }
    ...
    override fun createPeer(): ProjectGeneratorPeer<Settings> {
        val defaultSetupCheckbox = JBCheckBox(
            "vue.project.generator.use.default.project.setup",
    ...
    override fun presentablePackageName(): String {
        return "vue.project.generator.presentable.package.name"
    }
